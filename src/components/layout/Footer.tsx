      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-mobile md:px-margin-desktop max-w-[var(--spacing-container-max)] mx-auto">
        <div className="md:col-span-1 mb-10 md:mb-0">
          <Link href="/" className="block mb-6">
            <span className="font-display-lg text-headline-md tracking-tighter text-primary block">
              {hotelConfig.name}
            </span>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <Link
            href="/about"
            className="font-body-md text-body-md text-on-surface-variant hover:text-secondary underline-offset-4 hover:underline opacity-90 hover:opacity-100 transition-opacity"
          >
            About Us
          </Link>
          <Link
